# @zitterorg/earum-harum

> forked from [@zitterorg/earum-harumode](https://www.npmjs.com/package/@zitterorg/earum-harumode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@zitterorg/earum-harumode/issues/300).

[![npm version](https://img.shields.io/npm/v/@zitterorg/earum-harum.svg)](https://www.npmjs.com/package/@zitterorg/earum-harum)
[![Downloads](https://img.shields.io/npm/dm/@zitterorg/earum-harum.svg)](https://www.npmjs.com/package/@zitterorg/earum-harum)
[![Build Status](https://github.com/zitterorg/earum-harum/workflows/CI/badge.svg)](https://github.com/zitterorg/earum-harum/actions)
...
```sh
npm install --save-dev eslint @zitterorg/earum-harum
```
...
```js
const nodePlugin = require("@zitterorg/earum-harum")
...
💼 [Configurations](https://github.com/zitterorg/earum-harum#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/zitterorg/earum-harum#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/zitterorg/earum-harum#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/zitterorg/earum-harum#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/zitterorg/earum-harum#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/zitterorg/earum-harum#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/zitterorg/earum-harum#-configs).\
...
`@zitterorg/earum-harum` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/zitterorg/earum-harum/releases)
